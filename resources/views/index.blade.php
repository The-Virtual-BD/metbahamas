...
@section('content')
        ...
        <div class="container mx-auto py-7 sm:py-14">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                <div class="sm:col-span-2 shadow-lg">
                    <div class="h-[150px] sm:h-[212px] bg-today"></div>
                    <div class="px-5 sm:px-10 py-5">
                        <h3 class="font-os font-bold text-lg sm:text-2xl text-blue mb-4 sm:mb-7"><span
                                class="iconify inline mr-2.5" data-icon="charm:cloud"></span>Todays Update</h3>
                        <p class="text-sm sm:text-xl font-normal text-justify sm:text-left">The bahamas department of
                            meteorology has issued a severe
                ...
                <div class="shadow-lg pb-5 sm:pb-0">
                    <div class="h-[150px] sm:h-[212px] bg-todaycon min-w-full"></div>
                    <div class="px-5 py-2.5">
                        ...
                        <form action="">
                            <select name="" id=""
                                class="bg-blue rounded text-white px-4 text-sm sm:text-base">
                                @include('islands')
                            </select>
                        </form>
                    </div>
                    <div class="flex justify-between items-center px-5 text-sm sm:text-base">
                        <p class="text-blue font-semibold">Max 88 F</p>
                        <p class="text-blue font-semibold">Min 73 F</p>
                        <div class="border w-7 h-7 border-blue flex justify-center items-center rounded">F</div>
                    </div>
    ...
    <div class="py-7 sm:py-14 px-4 sm:px-0 container mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
            <div class="">
                <img src="https://cdn.star.nesdis.noaa.gov//GOES16/ABI/SECTOR/CAR/GEOCOLOR/GOES16-CAR-GEOCOLOR-1000x1000.gif"
                    alt="">
            </div>
            <div class="sm:col-span-2">

                <iframe class="w-full h-[400px] sm:h-full"
                    src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d1843587.4003844715!2d-78.67582681181828!3d25.513161509066325!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sregion%20of%20bahamas!5e0!3m2!1sen!2sbd!4v1664199465656!5m2!1sen!2sbd"
